...
export function ArtReviewer({
  ...
  const onPointerDown = useCallback(
    (e: React.PointerEvent) => {
      ...
      try {
        // The stroke follows the pointer even if it wanders off the stage — over
        // the ink rail, past the edge. This was removed for a while on the
        // theory that it was what dropped alternate letters; that turned out to
        // be iPadOS Scribble, so the platform's own mechanism is back in favour
        // of the hand-rolled document listener that replaced it.
